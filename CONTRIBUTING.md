...
issue](https://github.com/cisagov/cool-images-vmimport/issues) in this
...
request](https://github.com/cisagov/cool-images-vmimport/pulls), you
...
```console
cd cool-images-vmimport
pyenv virtualenv <python_version_to_use> cool-images-vmimport
pyenv local cool-images-vmimport
